<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active ">
            <a href="{{ url('admin/AboutUs') }}" class="menu-link" >
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">AboutUs</div>
            </a>
        </li>
        <li class="menu-item active ">
        ...
        <li class="menu-item active ">
            <a href="{{ url('admin/klien') }}" class="menu-link" >
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Daftar Klien</div>
            </a>
        </li>
        <li class="menu-item active ">
        ...
        <li class="menu-item active ">
            <a href="{{ url('admin/admin') }}" class="menu-link" >
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
