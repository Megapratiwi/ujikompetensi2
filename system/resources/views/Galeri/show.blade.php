                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        <a href=""data-bs-toggle="modal" data-bs-target="#Modalfotokeluhan">
                            <img class="img-thumbnail rounded" src="{{ url("public/$galeri->foto") }}"
                                style="height: 100%">
                        </a>                        
                        <div class="card-body">
                            @csrf
                            <dt class="col-sm-3">Judul Kegiatan</dt>
                            <dd class="col-sm-9"> : {{ $galeri->judul }}</dd>

                            <dt class="col-sm-3">Kegiatan</dt>
                            <dd class="col-sm-9"> : {{ $galeri->kegiatan }}</dd>

                            <dt class="col-sm-3">Tanggal Kegiatan</dt>
                            <dd class="col-sm-9"> : {{ $galeri->tanggal }}</dd>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{ url("public/$galeri->foto") }}" style="height: auto; max-width: 100%;"
                        alt="foto">
                </div>
            </div>
        </div>
