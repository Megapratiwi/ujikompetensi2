                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-success btn-block mg-b-15"
                                                    href="{{ "showkontak/$kontak->id" }}">
                                                    Lihat
                                                </a>
                                            </div>
                                            <div class="btn-group">
                                                <a class="btn btn-warning btn-block mg-b-10"
                                                    href="{{ "editkontak/$kontak->id" }}">
                                                    Edit
                                                </a>
                                            </div>
                                        </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('admin/storekontak') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col mb-3">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">No. Handphome</label>
                            ...
                            <div class="row g-3">
                                <div class="col mb-0">
                                    <label for="dobWithTitle" class="form-label">Instagram</label>
