...
@section('mega')
    <div class="body-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h6 class="mt-2 text-muted">Detail Data Kontak</h6>
                    <div class="card mb-4">
                        {{-- <a href=""data-bs-toggle="modal" data-bs-target="#Modalfotokeluhan">
                            <img class="img-thumbnail rounded" src="{{ url("public/$kontak->foto") }}"
                                style="height: 100%">
                        </a>                         --}}
                        <div class="card-body">
                            @csrf
                            ...
                            <dd class="col-sm-9"> : {{ $kontak->no_hp }}</dd>

                            <dt class="col-sm-3">Instagram</dt>
                            <dd class="col-sm-9"> : {{ $kontak->instagram }}</dd>

                            <dt class="col-sm-3">Alamat</dt>
                            <dd class="col-sm-9"> : {{ $kontak->alamat }}</dd>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{ url("public/$kontak->foto") }}" style="height: auto; max-width: 100%;"
                        alt="foto">
                </div>
            </div>
        </div>
